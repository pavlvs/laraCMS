...
class PagesController extends Controller
{
    ...
    public function store(WorkWithPage $request)
    {
        ...
        return redirect()->route('pages.index')->with('status', 'Page successfully added');
    }
    ...
    public function update(WorkWithPage $request, Page $page)
    {
        ...
        return redirect()->route('pages.index')->with('status', 'Page successfully updated');
    }
    ...
    protected function updatePageOrder(Page $page, WorkWithPage $request)
    {
